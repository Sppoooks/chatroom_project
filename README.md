...
Small project with the aim to learn the programming language C and networking.

# PURPOSE

A simple chatroom where clients can communicate between each other via text.
